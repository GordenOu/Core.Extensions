...
{
    [TestClass]
    public class StringParameterTest4 : NullCheckTest
    {
        public override Type CodeFixProviderType { get; } = typeof(AddDebugNullOrEmptyChecksCodeFixProvider);
        ...
        {
            return action.Title == Strings.AddDebugNullOrEmptyCheckTitle;
        }
