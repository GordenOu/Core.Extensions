...
{
    [TestClass]
    public class StringParameterTest6 : NullCheckTest
    {
        public override Type CodeFixProviderType { get; } = typeof(AddDebugNullOrWhitespaceChecksCodeFixProvider);
        ...
        {
            return action.Title == Strings.AddDebugNullOrWhitespaceCheckTitle;
        }
